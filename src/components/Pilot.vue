...
import gmsCrisisData from '@/assets/LCPs/gms-crisis-catalog_2.7'
import enhancedCombatData from '@/assets/LCPs/lancer-enhanced-combat-alt-frames_1.1'
import legionnaireData from '@/assets/LCPs/legionnaire_v1.0.0'
import solsticeRainData from '@/assets/LCPs/osr-data-1.2.0'
...
import terkmechandtechData from '@/assets/LCPs/tmat-data-0.19.0.0'
...
export default {
  ...
  data() {
    return {
      knownGear: [...lancerData.pilot_gear, ...nrfawData.pilot_gear, ...legionnaireData.pilot_gear, ...shadowOfTheWolfData.pilot_gear, ...sirensSongData.pilot_gear],
      activeMech: {},
      bond: {},
    }
  },
